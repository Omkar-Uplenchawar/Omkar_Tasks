...
const Experience = () => {
  ...
  const data = userDataLoadable.contents.timeline;
  const experience = data.filter((edu) => !edu.forEducation);
  const sortedExp = [...experience].sort((a, b) => a.sequence - b.sequence);
  ...
  return (
    <Container id="experience">
      <Wrapper>
        ...
        <TimelineSection>
          <Timeline>
            {sortedExp.map((experience, index) => (
