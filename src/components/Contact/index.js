...
const Contact = () => {
  ...
  const data = userDataLoadable.contents;
  ...
  return (
    <Container id="contact">
      ...
      <Wrapper>
      <ContactForm>
          <ContactTitle>My Info 🚀</ContactTitle>
          <ContactInfo>Role: {data.role}</ContactInfo>
          <ContactInfo>username: {data.username}</ContactInfo>
          <ContactInfo>Email: {data.email}</ContactInfo>
          <ContactInfo>Contact No.: {data.about.phoneNumber}</ContactInfo>
        </ContactForm>
